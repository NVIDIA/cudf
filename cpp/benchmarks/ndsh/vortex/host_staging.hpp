...
// Declare after buffer owners to drain before unwinding releases them.
// Cleanup follows RMM: assert drain success in Debug, ignore errors in Release.
// Explicit wait() propagates CUDA errors.
