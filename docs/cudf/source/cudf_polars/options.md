...
| `max_concurrent_io_tasks` | Number of concurrent IO producer tasks for each scan node. Automatic by default; set explicitly to tune IO throughput versus memory pressure.     | auto        |
