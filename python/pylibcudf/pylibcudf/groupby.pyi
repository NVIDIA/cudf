...
class GroupBy:
    ...
    def __init__(self, keys: Table, null_handling: NullPolicy=null_policy.EXCLUDE, keys_are_sorted: Sorted=sorted.NO, column_order: list[Order] | None=None, null_precedence: list[NullOrder] | None=None) -> None: ...
